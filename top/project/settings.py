...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-0^($oj0a!war2vk&ztivp2okoz-pgtru4_zf%x&%-^=p=hn5+!"
)
...
#################################
# C:PycharmProjects\docker_base\venv\Scripts\activate
# cd PycharmProjects\docker_base\top
